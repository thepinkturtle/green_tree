...
2. Open a terminal inside the root of this project (the "CODE" folder) and ensure you are in the virtual environment "evProject" that was set up in the INSTALLATION procedure above. You should see "(evProject)" at the beginning of your Terminal line to indicate the virtual environment is active. If not, re-run the following command to activate the virtual environment: source ./evProject/bin/activate
...
9. You should now be provided with the optimal path of charging stations to stop at during your trip based on your input objective. Scroll down or click the "Summary" button to see trip details and metrics.
10. To plan another trip, click the "Plan Another Trip" button in the top banner and then repeat steps 6-9 above.
11. To view results of our experiments on 10,000 simulated trips, click the graph icon in the top banner.
12. To shut down the Flask app when finished, return to your running terminal and hit Ctrl + C. 

----------- DEMO VIDEO -----------
URL of 1-minute install video: https://youtu.be/JhdaVZQXkv0
